...
def load_cairo_arabic():
    ...
    json_path = Path(__file__).resolve().parent.parent / "data" / "cairo_quran.json"
...
def convert_to_csv():
    input_file = Path(__file__).resolve().parent.parent / "data" / "all_variants_fixed.json"
    output_file = Path(__file__).resolve().parent.parent / "data" / "taisir_variants.csv"
