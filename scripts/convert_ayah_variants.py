...
def convert_to_csv():
    ...
    input_csv_path = submodule_root / "tests" / "ayah_variants_reference.csv"
    cairo_path = submodule_root / "data" / "cairo_quran.json"
    output_path = submodule_root / "data" / "ayah_numbering_variants.csv"
