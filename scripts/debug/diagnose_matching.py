...
def main():
    ...
    cairo_path = Path(__file__).resolve().parent.parent.parent / "data" / "cairo_quran.json"
    csv_path = Path(__file__).resolve().parent.parent.parent / "data" / "ayah_numbering_variants.csv"
